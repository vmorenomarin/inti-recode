...
# se debe crar un método en journals que constrassste el número de coleccciones locale vs. el número de coleccione en Scielo. Este método debe ser invocado por get_collections.
